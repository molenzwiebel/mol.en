...
module Molen
    class Module
        def add_primitives
            ...
            double.add_func("__lt", bool, double) { |b, f| b.ret b.fcmp :ult, f.params[0], b.si2fp(f.params[1], double.llvm_type) }
            double.add_func("__lte", bool, double) { |b, f| b.ret b.fcmp :ule, f.params[0], b.si2fp(f.params[1], double.llvm_type) }
            double.add_func("__gt", bool, double) { |b, f| b.ret b.fcmp :ugt, f.params[0], b.si2fp(f.params[1], double.llvm_type) }
            double.add_func("__lte", bool, double) { |b, f| b.ret b.fcmp :uge, f.params[0], b.si2fp(f.params[1], double.llvm_type) }
        end
    end
end